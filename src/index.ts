...
app.get("/alunos/all", async function ( req: Request, res: Response ): Promise<void> {
...
app.get("/alunos/teacher", async function ( req: Request, res: Response ): Promise<void> {
...
app.get("/Class/all", async function ( req: Request, res: Response ): Promise<void> {
